...
contract BiswapLottery is ReentrancyGuard, IBiswapLottery, Ownable {
    ...
    nonReentrant
    {
        ...
        require(bswSumPerBrackets <= _lotteries[_lotteryId].amountCollectedInBSW,
            'Wrong tickets count from given brackets');

        uint256 amountToInjectionToNextLottery = _lotteries[_lotteryId].amountCollectedInBSW - bswSumPerBrackets;
