...
// File: contracts/interfaces/IPBiswapLottery.sol
//RNG-01
pragma solidity 0.8.4;
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Biswap lottery
     */
    ...
    /**
     * @notice Set the address for the BiswapLottery
     * @param _biswapLottery: address of the Biswap lottery
     */
    function setLotteryAddress(address _biswapLottery) external onlyOwner {
